...
## 3D image matching
{: text-align: center;"}
By default CSVA runs is in "3D mode".
...
Matching under strong appearence changes. SURF+SIFT+CSVA
{: style="color:black; font-size: 100%; text-align: center;"}
...
Registration under season changes (left), matching old maps of Moscow (right). SURF+SIFT+CSVA
{: style="color:black; font-size: 100%; text-align: center;"}
